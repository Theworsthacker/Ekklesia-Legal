...
Ekklesia ("we", "our", or "us") provides support for users of the Ekklesia mobile application (the "App").

This Support page explains how you may contact us, request assistance, or resolve account-related issues when using the App.

By using the App, you acknowledge that support services are provided as described below.
...
If the App crashes, fails to load, or does not function properly, please provide detailed information about the issue so we can investigate and resolve it.
...
You may also email EkklesiaApp@outlook.com to request account deletion.

Account deletion requests are processed in accordance with our Privacy Policy.

---

## 7. Related Legal Policies
...
Terms of Service  
https://theworsthacker.github.io/Ekklesia-Legal/TERMS_OF_SERVICE.html  
